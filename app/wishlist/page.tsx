        ...
        <section className="flex min-h-[65vh] items-center justify-center px-5">
          ...
          <div className="max-w-lg text-center">
            ...
            <p className="mx-auto mt-5 max-w-sm text-sm leading-7 text-black/50">
              Save the ostren pieces you love and come back
              to them anytime.
            </p>
            ...
            {wishlistItems.map((item) => (
              ...
              >
                ...
                >
                  ...
                  <div
                    className={`relative aspect-[4/5] overflow-hidden ${item.className}`}
                  >

                    <div className="absolute inset-0 flex items-center justify-center">

                      <span className="font-serif text-4xl text-[#063b63]/20">
                        ostren
                      </span>
                ...
                <button
                  ...
                  className="absolute right-3 top-3 z-20 flex h-8 w-8 items-center justify-center rounded-full bg-white/90 text-[#0877b5] backdrop-blur-sm transition-transform hover:scale-105"
                >
                  <Heart
                    size={15}
                    strokeWidth={1.5}
